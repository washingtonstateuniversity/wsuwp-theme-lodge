...
if ( ! function_exists( 'wsuwp_lodge_setup' ) ) :
	 ...
	 */
	function wsuwp_lodge_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on WSU WP Lodge, use a find and replace
		 * to change 'wsuwp-lodge' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'wsuwp-lodge', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'wsuwp-lodge' ),
		) );
 ...
 */
function wsuwp_lodge_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'wsuwp_lodge_content_width', 640 );
}
add_action( 'after_setup_theme', 'wsuwp_lodge_content_width', 0 );
 ...
 */
function wsuwp_lodge_widgets_init() {
